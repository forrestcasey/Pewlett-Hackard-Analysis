...
--new temporary table (emp_info) to create
SELECT emp_no, 
	first_name, 
	last_name, 
	gender
...
--join emp_info to the salaries table to add the to_date and Salary columns to our query
--use dem alias to make it easier to read foo:
